...
if __name__ == "__main__":
    '''WORDS = [u'الْدَرَاجَةُ', u'الدّرّاجة',u'سّلّامْ', ]
    for wrd in WORDS:
    ...
    print ("similar: ", vocalized_similarity(u'ثمّ', u'ثُمَّ'))
    print ("like: ", vocalizedlike(u'ثمّ', u'ثُمَّ'))
    print ("similar: ", vocalized_similarity(u'ثم', u'ثُمَّ'))
    print ("like: ", vocalizedlike(u'ثم', u'ثُمَّ'))
    print ("similar: ", vocalized_similarity(u'مُتَوَهِّمًا', u'متوهمًا'))
    print ("similar: ", vocalized_similarity(u'مُتَوَهِّمًا', u'متوهمًا'))'''
    ...
    '''
    print("الْعَرَبِيّةُ بدون تشكييل عدا الشدة::"+strip_harakat(text))
    print("========================================")

    '''
    حذف الحركات بما فيها الشدة
    '''
    print("الْعَرَبِيّةُ بدون تشكييل بما فيها الشدة::"+strip_tashkeel(text))
    print("========================================")

'''
حذف الحركة الأخيرة فقط: قد تكون هي الحركة الإعرابية، لكن ليس في كل الحالات، مثلا يضربه، حركة الإعراب على الباء وليس على الهاء
'''
print("الْعَرَبِيّةُ بدون الحركة الأخيرة::" + strip_lastharaka(text))
print("========================================")

'''
اختزال التشكيل Reduce the Tashkeel, by deleting evident case
'''
print("الْعَرَبِيّةُ بعد إختزال التشكييل::" + reduce_tashkeel(text))
print("========================================")

'''
حذف التطويل أو الشدة
'''
word = u"العـــــــــــــــــــــــربيــــــــــــــــة"
print(" كلمة العـــــــــــــــــــــــربيــــــــــــــــة بدون التوطويل ::"+strip_tatweel(word))
print("========================================")
text1 = u"الشّمسيّة"
print("كلمة الشّمسيّة بدون الشدّة ::"+strip_shadda(text1))
print("========================================")
...
'''
text2 = u"لانها لالء الاسلام"
print("جملة 'لانها لالء الاسلام'  بعد تنميط الحروب المركبة بها :: "+normalize_ligature(text2))
print("========================================")
...
'''
text = u"سئل أحد الأئمة"
print(" جملة 'سئل أحد الأئمة' بعد توحيد الهمزة :: "+normalize_hamza(text))
print("========================================")
...
'''
#text =u"اَلْعَرَبِيَّةُ"
text = u"اَلْعَرَبَيَةُ"
letters, marks =separate(text)
print ("كلمة 'اَلْعَرَبَيَةُ' بدون الحركات :" + letters)
print("الحركات في كلمة 'اَلْعَرَبَيَةُ':")
print (marks)
for m in marks:
    print(name(m))
print("========================================")
...
'''
يمكن دمج الحركات والحروف في كلمة واحدة، شرط أن يكون طول السلسلتين متساويا. ينوب عن غياب الحركة حرف التطويل
joint the letters with the marks the length ot letters and marks must be equal return word
'''
letters = u"العربية"
marks   = u'\u064e\u0652\u064e\u064e\u064e\u064e\u064f'
word  = joint(letters,marks)
print("كلمة 'العربية' بعد إضافة الحركات :" + word)
print("========================================")

'''
حساب التماثل
التماثل في الحركات بين كلمتين يكون صحيحا إذا كان للكلمتين نفس الحروف، ونفس الحركات، ولو كانت الحركات ناقصة
...
word1 = u"ضَربٌ"
word2 = u"ضَرْبٌ"
print("هل الكلمتان 'ضَربٌ' و 'ضَرْبٌ' متماثلتان ؟ "+str(vocalizedlike(word1,word2)))
print("========================================")

'''
تماثل الوزن تتماثل كلمة مع وزن إذا كانت الحروف تتطابق مع الوزن والحركات مع الحركات، يمكن أن يكون التشكيل غير كامل
...
word1 = u"ضارب"
wazn =  u"فَاعِل"
print("هل كلمة 'ضارب' على وزن فاعل ؟ " + str(waznlike(word1,wazn)))
print("========================================")

'''
تتماثل كلمتان في الشدة إذ كانت لهما نفس المكان، والحركات أيضا وقد يكون التشكيل غير كامل
...
word2 = u"ردَّ"
word3 = u"رد"
print("هل الكلمتان 'ردّ' و 'ردًّ' متماثلتان في الشدة ؟ "+str(shaddalike(word1,word2)))
print("========================================")
print("هل الكلمتان 'رد' و 'ردّ' متماثلتان في الشدة ؟ "+str(shaddalike(word1,word3)))
print("========================================")

'''
حساب التماثل في الحركات
نقيس التماثل في الحركات ، بحيث كل اختلاف ننقص 1 فنحصل على عدد سالب حسب عدد مرات الاختلاف
...
word2 = u"ضَرْبٌ"
word3 = u"ضرب"
print("هل الكلمتان 'ضَربٌ' و 'ضَرْبٌ' متماثلتان في الحركات ؟ "+str(vocalizedlike(word1, word2)))
print("========================================")
print("هل الكلمتان 'ضَربٌ' و 'ضرب' متماثلتان في الحركات ؟ "+str(vocalizedlike(word1, word3)))
print("========================================")
word1 = u"ضَربٌ"
word2 = u"ضَرْبٍ"
print("هل الكلمتان 'ضَربٌ' و 'ضَرْبٍ' متماثلتان في الحركات ؟ "+str(vocalized_similarity(word1, word2)))
print("========================================")
...
print("كلمات جملة 'العربية لغة جميلة.' بعد تفريقها :")
print (u"\n".join(tokens))
print("========================================")
...
دوال الحروف وهي تعيد صواب إذا انتمى الحرف إلى المجموعة المطلوبة
                                           ...
                                           وصف الدالة	     الدالة
إذا كان الحرف المعطى سكونا يرجع True	            is_sukun(archar)
إذا كان الحرف المعطى شدة يرجع True	                is_shadda(archar) 
إذا كان الحرف المعطى تطويلا يرجع True	            is_tatweel(archar)
إذا كان الحرف المعطى تنوينا يرجع True	            is_tanwin(archar)
إذا كان الحرف المعطى تشكيلا (حركة أو شدة) يرجع True	is_tashkeel(archar)
إذا كان الحرف المعطى حركة يرجع True	                is_haraka(archar)
إذا كان الحرف المعطى حركة قصيرة يرجع True	        is_shortharaka(archar)
إذا كان الحرف المعطى لام ألف يرجع True	            is_ligature(archar)
إذا كان الحرف المعطى همزة يرجع True	                is_hamza(archar)
إذا كان الحرف المعطى ألفا يرجع True	                is_alef(archar)
إذا كان الحرف المعطى يماثل الياء في رسمه يرجع True	is_yehlike(archar)
إذا كان الحرف المعطى يماثل الواو في رسمه يرجع True	is_wawlike(archar)
إذا كان الحرف المعطى تاء مفتوحة أو مربوطة يرجع True	is_teh(archar)
إذا كان الحرف المعطى حرفا صغيرا يرجع True	        is_small(archar)
إذا كان الحرف المعطى حرف علة يرجع True	            is_weak(archar)
إذا كان الحرف المعطى حرفا قمريا يرجع True	        is_moon(archar)
إذا كان الحرف المعطى حرفا شمسيا يرجع True	        is_sun(archar)
...
print("نطق الكلمات باللام الشمسية والقمرية مثل : " + "'الشمس','القمر','الرجل','بصل','البصل' ::")
for word in words:
    if word.startswith(ALEF+LAM) and is_sun(word[2]):
        word=u''.join([ALEF+word[2],word[2:]]);
    print (word)

print("========================================")

'''
Unicode for each HARAKA
FATHATAN         = u'\u064b'
DAMMATAN         = u'\u064c'
KASRATAN         = u'\u064d'
FATHA            = u'\u064e'
...
print("حركات التشكيل أهي يا أولاد")
for haraka in HARAKAT_Dictionary:
    print (haraka+":"+HARAKAT_Dictionary.get(haraka))
